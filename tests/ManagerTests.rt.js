...
export class ManagerTests extends ATestSource {
    tests = [
        ...
        { for: "When storage call not ack'd and not already, outputs not-OK, 400, and fail message.", /* good */
          ...
          out: { ok: false, status: 400, content: "Bad request contents.  Patient not added.  Please review your input." } }, /* good */
        ...
        { for: "When storage call not ack'd and not already, outputs not-OK, 400, and fail message.", /* good */
          in: [ { acknowledged: false } ],
          out: { ok: false, status: 400, content: "Bad request contents.  Patient not removed.  Please review your input." } }, /* good */
